...
# Disabled for now, networking issues in the studio
#resource "nomad_job" "homeassistant-studio" {
#  jobspec = file("${path.module}/jobspecs/homeassistant/homeassistant-studio.hcl")
#}
...
resource "nomad_job" "audiomuse-worker" {
  jobspec = file("${path.module}/jobspecs/jellyfin/audiomuse-worker.hcl")
}
resource "nomad_job" "audiomuse-backend" {
  jobspec = file("${path.module}/jobspecs/jellyfin/audiomuse-backend.hcl")
}
...
resource "nomad_job" "renovate" {
  jobspec = file("${path.module}/jobspecs/renovate/renovate.hcl")
}
...
resource "nomad_job" "gotify" {
  jobspec = file("${path.module}/jobspecs/gotify/app.hcl")
}
