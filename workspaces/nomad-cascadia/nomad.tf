module "nomad-jobs" {
  ...
  immich_version = "v1.138.0" # image: ghcr.io/immich-app/immich-server

  homeassistant_version = "2025.8.2" # image: homeassistant/home-assistant
  ...
  authentik_version = "2025.6.4" # image: ghcr.io/goauthentik/server
