module "nomad-jobs" {
  ...
  immich_version = "v1.139.2" # image: ghcr.io/immich-app/immich-server

  homeassistant_version = "2025.8.3" # image: homeassistant/home-assistant
  zigbee2mqtt_version = "2.6.0" # image: koenkk/zigbee2mqtt
