module "nomad-jobs" {
  ...
  traefik_version = "v3.5.1" # image: traefik

  immich_version = "v1.140.1" # image: ghcr.io/immich-app/immich-server

  homeassistant_version = "2025.9.1" # image: homeassistant/home-assistant
  zigbee2mqtt_version = "2.6.1" # image: koenkk/zigbee2mqtt

  vaultwarden_version = "1.34.3" # image: vaultwarden/server

  nextcloud_version = "31.0.8" # image: nextcloud
  ...
  authentik_version = "2025.8.1" # image: ghcr.io/goauthentik/server
