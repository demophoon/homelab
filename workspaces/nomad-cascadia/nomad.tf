module "nomad-jobs" {
  ...
  immich_version = "v2.5.2" # image: ghcr.io/immich-app/immich-server

  homeassistant_version = "2026.1.3" # image: homeassistant/home-assistant
  ...
  vikunja_version = "1.0.0" #image: vikunja/vikunja
